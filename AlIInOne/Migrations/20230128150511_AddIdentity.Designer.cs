...
namespace AlIInOne.Migrations
{
    ...
    [Migration("20230128150511_AddIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlIInOne.Models.User", b =>
                {
                    ...
                    b.HasIndex("LecturerId")
                        .HasDatabaseName("ix_asp_net_users_lecturer_id");
            ...
            modelBuilder.Entity("AlIInOne.Models.User", b =>
                {
                    b.HasOne("AlIInOne.Models.Lecturer", "Lecturer")
                        .WithMany()
                        .HasForeignKey("LecturerId")
                        .HasConstraintName("fk_asp_net_users_lecturers_lecturer_id");

                    b.HasOne("AlIInOne.Models.Student", "Student")
                        .WithMany()
                        .HasForeignKey("StudentId")
                        .HasConstraintName("fk_asp_net_users_students_student_id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AlIInOne.Models.User", null)
                        .WithMany()
